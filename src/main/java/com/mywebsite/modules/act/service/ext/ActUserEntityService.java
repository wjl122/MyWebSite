package com.mywebsite.modules.act.service.ext;
...
import com.mywebsite.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.mywebsite.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.mywebsite.modules.sys.entity.User(null, userId)))){
